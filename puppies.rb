...
def some_puppies(numPuppies, maxPuppies)
  if numPuppies < (maxPuppies /2)
     "Good job, Rachel!"
  elsif numPuppies > maxPuppies
 "Get back to your animal goals!"
  end
end
...
def both_animals (numPuppies, numCats)
  if(numPuppies == 0 || numCats == 0)
    "Good job!"
  elsif (numPuppies >= 1 && numCats >= 1)
 "Get back to your animal goals!"
end
end